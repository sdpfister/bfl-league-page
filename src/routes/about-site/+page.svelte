...
<div class="about">
    <h1 class="noUnderscore">ABOUT THE BFL SITE</h1>
    ...
    <div class="subBlock">
        <p>Eager to see how this website will evolve? Take a peek at our <a href="/roadmap">Roadmap</a> for a glimpse of the enhancements and new features we're working on.</p>
    </div>
</div>